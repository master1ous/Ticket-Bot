...
module.exports = {
    ...
    run: async (client, interaction, args) => {
      ...
      //.addFields(categories)
        .setDescription(`**${client.user.username} is the Next Generation of Ticket Creations! With \\☁️ Powerful Systems, Quick Database, \\🎫 Multiple Ticket Systems, and much more!**`)
